...
osc1 = 24.5*ones(osc_t*100/9);
osc2 = 21.9*ones(osc_t*100/9);
osc3 = 24.5*ones(osc_t*100/9);
osc4 = 21.9*ones(osc_t*100/9);
osc5 = 24.5*ones(osc_t*100/9);
osc6 = 20.1*ones(osc_t*100/9);
osc7 = 24.5*ones(osc_t*100/9);
osc8 = 20.1*ones(osc_t*100/9);
osc9 = 24.5*ones(osc_t*100/9);
