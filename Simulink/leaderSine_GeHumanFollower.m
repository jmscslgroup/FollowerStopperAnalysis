...
%% ORGANIZE DATA
load leaderSine_GeHumanFollower_xpos.mat
t_xpos  = leaderSine_GeHumanFollower_xpos.time;
lead_xpos = leaderSine_GeHumanFollower_xpos.signals(1).values;
follower_xpos = leaderSine_GeHumanFollower_xpos.signals(2).values;

load leaderSine_GeHumanFollower_ypos.mat
t_ypos  = leaderSine_GeHumanFollower_ypos.time;
lead_ypos = leaderSine_GeHumanFollower_ypos.signals(1).values;
follower_ypos = leaderSine_GeHumanFollower_ypos.signals(2).values;

load leaderSine_GeHumanFollower_vel.mat
t_vel  = leaderSine_GeHumanFollower_vel.time;
lead_vel = leaderSine_GeHumanFollower_vel.signals(1).values;
follower_vel = leaderSine_GeHumanFollower_vel.signals(2).values;

% load leaderSine_GeHumanFollower_acc.mat
% t_acc  = leaderSine_GeHumanFollower_acc.time;
% lead_acc = leaderSine_GeHumanFollower_acc.signals(1).values;
% follower_acc = leaderSine_GeHumanFollower_acc.signals(2).values;
